...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      {
        source: "/api/game/newGetGames",
        destination: `${APIURL}:3001/game/newGetGames`,
      },
      {
        source: "/api/game/newReservedGame",
        destination: `${APIURL}:3001/game/newReservedGame`,
      },
      {
        source: "/api/logs/checkedLog",
        destination: `${APIURL}:3001/logs/checkedLog`,
      },
      {
        source: "/getReserveLog",
        destination: `${APIURL}:3001/logs/getReserveLog`,
      },
      {
        source: "/addReserveLog",
        destination: `${APIURL}:3001/logs/addReserveLog`,
      },
    ];
  },
};
